...
to radial highways (rad), and the full-value propety tax rate per $10,000 (tax) predictor variables. Additionally, the weighted 
...
#### since model 4 has the highest sensitvity (low false negative) rate we will be picking that model to predict on the evaluation set
