...
The next step in our data exploration is to check for missing values in the data. As we can see from the below missingness map, there are no missing values and therefore we do not need to impute any of the values.
