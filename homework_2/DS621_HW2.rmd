...
roc_curve_generator <- function(class, probability) {
  # Loop through the thresholds and create a dataframe for each item (0, 1, 0.01).
  ...
  plot(FPR, TPR, 'l', main = 'ROC Curve', xlab = 'False Positive Rate', ylab = 'True Positive Rate')
  grid (10, 10, lty = 6, col = 'palevioletred1')
  polygon(c(FPR, 1, 1), c(TPR, 0, 1), col = 'green', density = 20, angle = 45)
  polygon(c(0, 0, 1, 1), c(0, 1, 1, 0), col = 'black', density = 0, lty = 6)
  abline(a = 0, b = 1, col = 'red')
  legend(0.5, 0.45, AUC, title = 'AUC')
}
