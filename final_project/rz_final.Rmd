...
### Data Analysis
The first step in our data analysis was to check for missing values. As you can see from the data summary below, there are quite a few columns with missing values. The main offenders are at the top of the list.
