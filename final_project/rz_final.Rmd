...
```{r, modelTwoRisiduals,  warning=FALSE, message=FALSE, echo=FALSE}
...
```{r, modelThreeRisiduals,  warning=FALSE, message=FALSE, echo=FALSE}
...
prices.test$SalePrice = predict(model3, test.impute)
